  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("Gorevler")
          .doc(mevcutkullaniciUidTutucu).collection("Gorevlerim").snapshots(),
            ...
            if(veriTabanindanGelenVeriler.connectionState == ConnectionState.waiting) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context,index){
                  var eklemeZamani = (alinanVeri[index]['tamZaman'] as Timestamp).toDate();
                  return Container(
                    ...
                    Text(DateFormat.yMd().add_jm().format(eklemeZamani).toString(),
                      style: TextStyle(fontSize: 24),
                          ...
                          Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Text(alinanVeri[index][index]['sonTarih'],
                              style: TextStyle(
                                fontSize: 18,
